...
#run_file "/home/b08x/Studio/scripts/sonic-stuff/introduction.rb"
    ...
    with_fx :bpf, centre: 114, res: 0.8 do
      with_fx :hpf, cutoff: 40,pre_amp: 3 do
        with_fx :reverb, room: 0.4, damp: 0.3 do
          ...
          h = sample_duration SAMPLES, "notcrazyenough", attack: 0.25, release: 0.25

          sample SAMPLES, "notcrazyenough", attack: 0.125, release: 0.125, amp: 2.25, pan: -0.5, pan_slide: h.round(2) do |x|
            control x, pan: 1
          end
    ...
    with_fx :level, amp: 0.45, amp_slide: 4 do |a|
      with_fx :reverb, room: 0.6, damp: 0.4 do
        with_fx :band_eq, freq: 38, db: 6, res: 0.6 do
          play_hydro_seq(distribute(7, 16), "35_bass_4")
        end
      end
    end
  end
        ...
        with_fx :level, amp: 2 do
          with_fx :bitcrusher, cutoff: 40, pre_mix: 0.5 do
            with_fx :lpf, cutoff: 60 do
              sample SAMPLES, "youvepickedglassesman", hpf: 45, start: 0.25, finish: 0.2791, attack: 2, release: 1, rate: range(1, -1, step: 2, inclusive: true).tick
            end
          end
        end
      end
    ...
    with_fx :band_eq, freq: 38, db: 6, res: 0.6 do
      with_fx :level, amp: 0.15 do
        with_fx :reverb, room: 0.6, damp: 0.4 do
          ...
          sample PERCS, "EE_Kick_Power" if spread(1,8).tick


          sample PERCS, "EE_Hat_Cl_Dirty" if spread(2,8).look

          #
          #sample SAMPLES, "sim_k02-0_1" if spread(3,8).look


          sample PERCS, "EE_Kick_Hard_1" if spread(2,8).look
...
at 122 do
  ...
  @fish = in_thread do
    ...
    sample SOUNDSCAPES, "klankbeeld_pedestrian_area_city_nl_03_160319_00", attack: 8, release: 8, start: 0.08, finish: 0.56, pan: -1, pan_slide: 16 do |p|
      2.times do
        control p, pan: 1
        sleep 16
        control p, pan: -1
  ...
  3.times do
    ...
    smooth_up: 1.5, smooth_down: 1.5 do
      with_fx :mono do
        sample FX, "SCSS-Sequence-08", attack: 2, release: 0.25, pre_amp: 0.05
      end
    end

    sleep sample_duration FX, "SCSS-Sequence-08", attack: 2, release: 0.25
    sleep 4
...
at 220 do
  ...
  with_fx :level, amp: 0.10 do |lv|
    ...
    with_fx :reverb, room: 0.6, damp: 0.6, pre_mix: 0.9 do
      ...
      sample FX, "SCSS-Mystery-Word", start: 0, finish: 0.4
      ...
      8.times do |x|
        ...
        with_fx :echo, decay: 0.125, phase: 0.125, pre_mix: 0.5 do
          ...
          sample SYNTHS, "SMA-englishEdition",
            rate: 1.25, slice: x, num_slices: 18, pan: ptrpan,
            attack: 0.25, release: 0.25
        end
        sleep sample_duration SYNTHS, "SMA-englishEdition", rate: 0.75, slice: x, num_slices: 36, pan: ptrpan, attack: 0.25, release: 0.25
      ...
      sample FX, "SCSS-Correct", attack: 0.125, release: 0.125
