    ...
    with_fx :band_eq, freq: 38, db: 6, res: 0.6 do
      with_fx :level, amp: 0.15 do
        with_fx :reverb, room: 0.6, damp: 0.4 do
          ...
          sample DRUMKITS, "EE_Kick_Power" if spread(1,8).tick


          sample DRUMKITS, "EE_Hat_Cl_Dirty" if spread(2,8).look

          #
          sample DRUMKITS, "sim_k02-0_1" if spread(3,8).look


          sample DRUMKITS, "EE_Kick_Hard_1" if spread(2,8).look
